          ...
          children: [
            Column(
              children: [
                ...
                Column(
                  children: [
                    VideoContentItem("url_thumbnail_video","5 tips berkenalan dengan orang baru","basic","url_video"),
                    VideoContentItem("url_thumbnail_video","tips agar tidak baperan","basic","url_video"),
                    VideoContentItem("url_thumbnail_video","tips hidup sehat","basic","url_video"),
                    VideoContentItem("url_thumbnail_video","tetap positive thinking","basic","url_video"),
                    VideoContentItem("url_thumbnail_video","cara menaham emosi","basic","url_video"),
                    VideoContentItem("url_thumbnail_video","cara bersikap dewasa","basic","url_video"),
                    VideoContentItem("url_thumbnail_video","gatau apalagi","basic","url_video"),
                  ],
                )
